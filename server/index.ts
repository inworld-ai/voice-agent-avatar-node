...
import { startHeygenSession } from "./routes/start-heygen-session";
import { stopHeygenSession } from "./routes/stop-heygen-session";
...
app.post("/api/start-session", startHeygenSession);
app.post("/api/stop-session", stopHeygenSession);
